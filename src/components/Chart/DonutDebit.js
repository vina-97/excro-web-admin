...
const DonutDebit = (props) => {
  const [chartOptions, setChartOptions] = useState({
    ...
    options: {
      ...
      title: {
        text: 'Debit Count Transaction Percentage',
      },
      responsive: [
        {
          breakpoint: 480,
  ...
  useEffect(() => {
    ...
    const { successPercentage, pendingPercentage, failurePercentage } =
      props.percentage.transaction_count?.DEBIT;
  ...
  return (
    <div>
      <div id="chart" className='donutCredit'>
        <ReactApexChart
